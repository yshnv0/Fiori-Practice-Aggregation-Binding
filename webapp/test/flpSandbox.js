		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comapplexusaggregationbinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusaggregationbinding-display": {
								"semanticObject": "comapplexusaggregationbinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.aggregationbinding",
									"url": sap.ui.require.toUrl("com/applexus/aggregationbinding")
								}
							}
						}
					}
